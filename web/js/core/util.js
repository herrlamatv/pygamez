...
(function () {
  ...
  const GAME_STR = {
    fr: { "web.chess.subtitle": "Échecs classiques contre l'IA", "web.connect4.subtitle": "Quatre en ligne - contre l'IA", "web.reversi.subtitle": "Encercler et retourner les pions - contre l'IA", "web.reversi.pass_ai": "L'IA doit passer", "web.reversi.pass_you": "Tu dois passer", "web.snake.boost_hint": "Boost en jeu :  maintenir Espace/Maj ou Entrée", "web.muehle.subtitle": "Jeu du moulin – contre l'IA", "web.tanks.controls_hint": "WASD ou flèches = rouler   -   Espace ou Entrée = tirer" },
    es: { "web.chess.subtitle": "Ajedrez clásico contra la IA", "web.connect4.subtitle": "Cuatro en raya - contra la IA", "web.reversi.subtitle": "Encierra y voltea fichas - contra la IA", "web.reversi.pass_ai": "La IA tiene que pasar", "web.reversi.pass_you": "Tienes que pasar", "web.snake.boost_hint": "Turbo en juego:  mantén Espacio/Shift o Intro", "web.muehle.subtitle": "Molino – contra la IA", "web.tanks.controls_hint": "WASD o flechas = conducir   -   Espacio o Intro = disparar" },
    pt: { "web.chess.subtitle": "Xadrez clássico contra a IA", "web.connect4.subtitle": "Quatro em linha - contra a IA", "web.reversi.subtitle": "Cercar e virar peças - contra a IA", "web.reversi.pass_ai": "A IA tem de passar", "web.reversi.pass_you": "Tens de passar", "web.snake.boost_hint": "Boost no jogo:  mantém Espaço/Shift ou Enter", "web.muehle.subtitle": "Moinho – contra a IA", "web.tanks.controls_hint": "WASD ou setas = conduzir   -   Espaço ou Enter = disparar" },
    pl: { "web.chess.subtitle": "Klasyczne szachy przeciwko SI", "web.connect4.subtitle": "Cztery w rzędzie - przeciwko SI", "web.reversi.subtitle": "Otaczaj i odwracaj pionki - przeciwko SI", "web.reversi.pass_ai": "SI musi spasować", "web.reversi.pass_you": "Musisz spasować", "web.snake.boost_hint": "Boost w grze:  przytrzymaj Spację/Shift lub Enter", "web.muehle.subtitle": "Młynek – przeciwko SI", "web.tanks.controls_hint": "WASD lub strzałki = jazda   -   Spacja lub Enter = strzał" },
    tr: { "web.chess.subtitle": "Yapay zekâya karşı klasik satranç", "web.connect4.subtitle": "Dörtlü sıra - yapay zekâya karşı", "web.reversi.subtitle": "Taşları kuşat ve çevir - yapay zekâya karşı", "web.reversi.pass_ai": "Yapay zekâ pas geçmeli", "web.reversi.pass_you": "Pas geçmelisin", "web.snake.boost_hint": "Oyunda hız:  Boşluk/Shift veya Enter'a basılı tut", "web.muehle.subtitle": "Dokuz Taş – yapay zekâya karşı", "web.tanks.controls_hint": "WASD veya oklar = sür   -   Boşluk veya Enter = ateş" },
    da: { "web.chess.subtitle": "Klassisk skak mod AI'en", "web.connect4.subtitle": "Fire på stribe - mod AI'en", "web.reversi.subtitle": "Indeslut og vend brikker - mod AI'en", "web.reversi.pass_ai": "AI'en må melde pas", "web.reversi.pass_you": "Du må melde pas", "web.snake.boost_hint": "Boost i spillet:  hold Mellemrum/Shift eller Enter", "web.muehle.subtitle": "Mølle – mod AI'en", "web.tanks.controls_hint": "WASD eller pile = kør   -   Mellemrum eller Enter = skyd" },
    no: { "web.chess.subtitle": "Klassisk sjakk mot KI-en", "web.connect4.subtitle": "Fire på rad - mot KI-en", "web.reversi.subtitle": "Omring og snu brikker - mot KI-en", "web.reversi.pass_ai": "KI-en må stå over", "web.reversi.pass_you": "Du må stå over", "web.snake.boost_hint": "Boost i spillet:  hold Mellomrom/Shift eller Enter", "web.muehle.subtitle": "Mølle – mot KI-en", "web.tanks.controls_hint": "WASD eller piler = kjør   -   Mellomrom eller Enter = skyt" },
    sv: { "web.chess.subtitle": "Klassiskt schack mot AI:n", "web.connect4.subtitle": "Fyra i rad - mot AI:n", "web.reversi.subtitle": "Ringa in och vänd brickor - mot AI:n", "web.reversi.pass_ai": "AI:n måste passa", "web.reversi.pass_you": "Du måste passa", "web.snake.boost_hint": "Boost i spelet:  håll ned Mellanslag/Shift eller Enter", "web.muehle.subtitle": "Kvarnspel – mot AI:n", "web.tanks.controls_hint": "WASD eller pilar = kör   -   Mellanslag eller Enter = skjut" },
    fi: { "web.chess.subtitle": "Klassista shakkia tekoälyä vastaan", "web.connect4.subtitle": "Neljän suora - tekoälyä vastaan", "web.reversi.subtitle": "Saarra ja käännä nappulat - tekoälyä vastaan", "web.reversi.pass_ai": "Tekoälyn on passattava", "web.reversi.pass_you": "Sinun on passattava", "web.snake.boost_hint": "Boost pelissä:  pidä Välilyönti/Shift tai Enter pohjassa", "web.muehle.subtitle": "Mylly – tekoälyä vastaan", "web.tanks.controls_hint": "WASD tai nuolet = aja   -   Välilyönti tai Enter = ammu" },
    cs: { "web.chess.subtitle": "Klasické šachy proti AI", "web.connect4.subtitle": "Čtyři v řadě - proti AI", "web.reversi.subtitle": "Obklič a otoč kameny - proti AI", "web.reversi.pass_ai": "AI musí passovat", "web.reversi.pass_you": "Musíš passovat", "web.snake.boost_hint": "Boost ve hře:  drž Mezerník/Shift nebo Enter", "web.muehle.subtitle": "Mlýn – proti AI", "web.tanks.controls_hint": "WASD nebo šipky = jízda   -   Mezerník nebo Enter = palba" },
    sl: { "web.chess.subtitle": "Klasični šah proti UI", "web.connect4.subtitle": "Štiri v vrsto - proti UI", "web.reversi.subtitle": "Obkoli in obrni žetone - proti UI", "web.reversi.pass_ai": "UI mora izpustiti potezo", "web.reversi.pass_you": "Moraš izpustiti potezo", "web.snake.boost_hint": "Pospešek v igri:  drži Preslednico/Shift ali Enter", "web.muehle.subtitle": "Mlin – proti UI", "web.tanks.controls_hint": "WASD ali puščice = vožnja   -   Preslednica ali Enter = strel" },
    hr: { "web.chess.subtitle": "Klasični šah protiv UI", "web.connect4.subtitle": "Četiri u nizu - protiv UI", "web.reversi.subtitle": "Okruži i okreni žetone - protiv UI", "web.reversi.pass_ai": "UI mora preskočiti potez", "web.reversi.pass_you": "Moraš preskočiti potez", "web.snake.boost_hint": "Boost u igri:  drži Razmaknicu/Shift ili Enter", "web.muehle.subtitle": "Mlin – protiv UI", "web.tanks.controls_hint": "WASD ili strelice = vožnja   -   Razmaknica ili Enter = pucaj" },
  };
