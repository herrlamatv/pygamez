...
highscore.py
============
Laedt und speichert Highscores in einer lokalen JSON-Datei.
...
def load_highscores():
    """Liest die Highscores. Gibt ein dict {spiel_key: score} zurueck."""
    ...
    try:
        ...
        # Beschaedigte Datei -> mit leeren Highscores weiterarbeiten
        return {}
...
def save_highscores(scores):
    ...
    try:
        ...
        # Wenn das Speichern fehlschlaegt (z.B. keine Schreibrechte),
...
def update_highscore(key, score):
    """
    Aktualisiert den Highscore fuer 'key', falls 'score' besser ist.
    Gibt (neuer_highscore, ist_neuer_rekord) zurueck.
    """
